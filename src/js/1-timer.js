...
let dayElement = document.querySelector('[data-days]');
let hourElement = document.querySelector('[data-hours]');
let minuteElement = document.querySelector('[data-minutes]');
let secondElement = document.querySelector('[data-seconds]');
